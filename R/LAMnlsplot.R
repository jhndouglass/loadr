...
LAMnlsplot <- function(x, y, ...){
        ...
        gg <- gg + ggplot2::theme(plot.title = ggplot2::element_text(size = ggplot2::rel(titlesize), face = "bold"),
                         axis.title.x = ggplot2::element_text(face = "bold", size = ggplot2::rel(axissize)),
                         axis.title.y = ggplot2::element_text(face = "bold", size = ggplot2::rel(axissize)),
        ...
        gg2 <- gg2 + ggplot2::theme(plot.title = ggplot2::element_text(size = ggplot2::rel(titlesize), face = "bold"),
                           axis.title.x = ggplot2::element_text(face = "bold", size = ggplot2::rel(axissize)),
                           axis.title.y = ggplot2::element_text(face = "bold", size = ggplot2::rel(axissize)),
                           panel.background = ggplot2::element_rect(fill = NA),
                           panel.grid.minor = ggplot2::element_line(colour = NA),
        ...
        gg3 <- gg3 + ggplot2::theme(plot.title = ggplot2::element_text(size = ggplot2::rel(titlesize), face = "bold"),
                           axis.title.x = ggplot2::element_text(face = "bold", size = ggplot2::rel(axissize)),
                           axis.title.y = ggplot2::element_text(face = "bold", size = ggplot2::rel(axissize)),
                           panel.background = ggplot2::element_rect(fill = NA),
                           panel.grid.minor = ggplot2::element_line(colour = NA),
